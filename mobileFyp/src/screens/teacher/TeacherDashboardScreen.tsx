...
import { fetchRecentActivities } from '../../services/teacherService';
...
const QUICK_ACTIONS = [
  {
    key: 'requests',
    title: 'View Requests',
    description: 'Review supervision requests',
    route: 'SupervisionRequests',
    icon: 'user-check',
    color: '#22c55e',
  },
  {
  ...
  },
  {
    key: 'files',
    title: 'View Files',
    description: 'Student file uploads',
    route: 'UploadedFiles',
    icon: 'file-text',
    color: '#06b6d4',
  },
...
export function TeacherDashboardScreen() {
  ...
  return (
    <PortalScreenLayout
      title="Dashboard"
      subtitle="Manage your projects and supervise students"
