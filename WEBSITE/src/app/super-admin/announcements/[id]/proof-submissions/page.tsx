...
export default function AdminProofSubmissionsPage() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load announcement
      const announcementRes = await fetch(`/api/announcements/${params.id}`)
      ...
      // Load submissions
      const submissionsRes = await fetch(`/api/admin/proof-submissions?announcementId=${params.id}`)
  ...
  const handleReview = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/admin/proof-submissions/${selectedSubmission.id}/review`, {
        method: 'POST',
        headers: {
